...
public class EMSTask extends TimerTask {
	
	private static final String CONTEXT_NAME = "ems-queue-daemon-context.xml";
	
	private static Log logger = LogFactory.getLog(EMSTask.class);
	
	private static JdbcTemplate wmJdbcTemplate;
	
	private static final  String selectSQL = "select taskid from ems_task where channel_type = 'NCP' and status = 4 and scheduledon >= TO_DATE ('2016-12-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS') and rownum <=500 order by scheduledon asc";;
